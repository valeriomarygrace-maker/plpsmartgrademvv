...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($scoreUpdated) {
        echo "<script>window.location.href = 'subject-management.php?subject_id=$subject_id&term=$term&show_insights=true';</script>";
        exit;
    }
}
...
<head>
    ...
    <title><?php echo ucfirst($term); ?> Evaluation - <?php echo htmlspecialchars($subject['subject_code']); ?> - PLP SmartGrade</title>
    ...
    <style>
        ...
        * {
        ...
        .term-indicator {
            background: <?php echo $term === 'midterm' ? '#3b82f6' : '#ef4444'; ?>;
            color: white;
            padding: 0.5rem 1rem;
            border-radius: 20px;
            font-weight: 600;
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <div class="header-actions">
                <a href="termevaluation.php?subject_id=<?php echo $subject_id; ?>" class="btn btn-secondary">
