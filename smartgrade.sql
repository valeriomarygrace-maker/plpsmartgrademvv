...
CREATE TABLE public.messages (
  ...
  sender_type character varying NOT NULL CHECK (sender_type::text = ANY (ARRAY['student'::character varying, 'admin'::character varying]::text[])),
  receiver_id bigint NOT NULL,
  receiver_type character varying NOT NULL CHECK (receiver_type::text = ANY (ARRAY['student'::character varying, 'admin'::character varying]::text[])),
